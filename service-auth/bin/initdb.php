...
$db->exec(sprintf("
    INSERT INTO saml_entities (`entity_id`, `sso`, `slo`, `cert`) 
    VALUES ('%s', '%s', '%s', '%s')",
    ...array_map([$db, 'escapeString'], [
        'https://app.onelogin.com/saml/metadata/709016',
        'https://andy-dev.onelogin.com/trust/saml2/http-post/sso/709016',
        'https://andy-dev.onelogin.com/trust/saml2/http-redirect/slo/709016',
